#ifndef DEF_LIEVARIATIONAL_EULERSTEPINTERNALS
#define DEF_LIEVARIATIONAL_EULERSTEPINTERNALS
...
template <typename T_M,
		  typename T_Q,
		  typename T_ALGEBRA>
class EulerStepInternals : public Abstract::StepInternals<T_M,T_Q,T_ALGEBRA>, public ::Abstract::NOXStep<T_ALGEBRA,1>
{
public:
	EulerStepInternals<T_M,T_Q,T_ALGEBRA> (Abstract::Problem<T_M,T_Q,T_ALGEBRA>& problem)
	:	Abstract::StepInternals<T_M,T_Q,T_ALGEBRA>(problem)
	{ }
