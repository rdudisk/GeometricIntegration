...
public:
	...
	:	Abstract::Step<T_M,T_Q,T_TQ>(problem)
	{
		...
		Abstract::StepInternals<T_M,T_Q,T_TQ>* internals = new Abstract::StepInternals<T_M,T_Q,T_TQ>(problem);
		...
		Abstract::StepInternals<T_M,T_Q,T_TQ>* tmp = static_cast<Abstract::StepInternals<T_M,T_Q,T_TQ>*>(this->m_internals);
