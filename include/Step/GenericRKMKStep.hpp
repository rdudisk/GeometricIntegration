#ifndef DEF_GENERIC_RKMK_STEP
#define DEF_GENERIC_RKMK_STEP
...
public:
	RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES> (Abstract::Problem<T_M,T_Q,T_LIE_ALGEBRA>& interface)
	:	m_interface(interface)
	{ setTruncatureOrder(); }

	static RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>&
	newFromProblem (Abstract::Problem<T_M,T_Q,T_LIE_ALGEBRA>& interface)
	{
		RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>* res = new RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>(interface);
		return *res;
	}

	void
	operator= (const RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>& other)
	{
...
{ 
protected:
	Abstract::RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>* m_internals;
	Abstract::Problem<T_M,T_Q,T_LIE_ALGEBRA>& m_interface;
	char m_type;
...
public:
	...
	{
		m_internals = new Abstract::RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>(interface);
		setType();
	}
	...
	*/
	...
	~RKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES> ()
	{ }
	...
	setType ( )
	{
		...
		if (isExplicit)
			m_type = RKMKStep::TYPE_EXPLICIT;
		else if (isDIRK)
			m_type = RKMKStep::TYPE_DIAGONAL_IMPLICIT;
		else
			m_type = RKMKStep::TYPE_UNKNOWN;
	}
...
template <typename T_M,
		  ...
		  typename T_LIE_ALGEBRA,
		  int T_N_INTERNAL_STAGES>
class ExplicitRKMKStep : public Abstract::RKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>
{
public:
	ExplicitRKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES> (Abstract::Problem<T_M,T_Q,T_LIE_ALGEBRA>& interface)
	:	Abstract::RKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>(interface)
	{ }
...
template <typename T_M,
		  ...
		  typename T_LIE_ALGEBRA,
		  int T_N_INTERNAL_STAGES>
class DIRKMKStepInternals : public Abstract::RKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>, public Abstract::Step<T_Q,1>
{
private:
	int m_fevals;
...
public:
	DIRKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES> (Abstract::Problem<T_M,T_Q,T_LIE_ALGEBRA>& interface)
...
template <typename T_M,
		  ...
		  typename T_LIE_ALGEBRA,
		  int T_N_INTERNAL_STAGES>
class DIRKMKStep : public Abstract::RKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>
{
private:
...
public:
	DIRKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES> (Abstract::Problem<T_M,T_Q,T_LIE_ALGEBRA>& interface)
	:	Abstract::RKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>(interface)
	{
		// m_internals is already initalized by base constructor, overriding
		DIRKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>* internals = new DIRKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>(interface);
		...
		DIRKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>* tmp = static_cast<DIRKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>*>(this->m_internals);
	...
	~DIRKMKStep<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES> ()
	{ }
	...
	makeStep (void)
	{
		...
		for (int i=0; i<T_N_INTERNAL_STAGES; i++) {
			try {
				(static_cast<DIRKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>*>(this->m_internals))->currentStep(i);
				...
				(static_cast<DIRKMKStepInternals<T_M,T_Q,T_LIE_ALGEBRA,T_N_INTERNAL_STAGES>*>(this->m_internals))->setSolutionK(solnVec);
